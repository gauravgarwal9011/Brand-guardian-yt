...
def index_docs():
    """
    Read PDFs from backend/data, chunk them, and uploads vectors to Azure AI Search.
    """
    # 2. Define Paths
    ...
    if all_splits:
        ...
        try:
            # Azure Search accepts batches automatically via this methos
